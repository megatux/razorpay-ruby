...
module Razorpay
  # Tests for Razorpay::FundAccount.new(@client).
  class RazorpayFundAccountTest < Minitest::Test
    ...
    def test_fund_account_should_be_defined
      refute_nil Razorpay::FundAccount.new(@client)
    end
    ...
    def test_fund_account_should_be_created
      ...
      fund_account = Razorpay::FundAccount.new(@client).create param_attr.to_json
    ...
    def test_fetch_all_fund_accounts
      ...
      fund_accounts = Razorpay::FundAccount.new(@client).all(para_attr.to_json)
