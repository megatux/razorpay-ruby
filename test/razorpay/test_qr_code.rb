...
module Razorpay
  ...
  class RazorpayQrCodeTest < Minitest::Test
    ...
    def test_qrcode_should_be_created
      ...
      qr_code = Razorpay::QrCode.new(@client, {}).create(para_attr.to_json)
    ...
    def test_fetch_all_qcode
      qr_code = Razorpay::QrCode.new(@client, {}).all
      assert_instance_of Razorpay::Collection, qr_code
    end

    def test_fetch_specific_qrcode
      qr_code = Razorpay::QrCode.new(@client, {}).fetch(@qrcode_id)
    ...
    def test_qrcode_close
      ...
      qr_code = Razorpay::QrCode.new(@client, {}).fetch(@qrcode_id).close
      assert_instance_of Razorpay::QrCode, qr_code
      assert_equal qr_code.id, @qrcode_id
    end
    ...
    def test_qrcode_fetch_payments
      ...
      qr_code = Razorpay::QrCode.new(@client, {}).fetch(@qrcode_id).fetch_payments()
      assert_instance_of Razorpay::Collection, qr_code
    end
  end
end
