...
module Razorpay
  ...
  class RazorpaySettlementTest < Minitest::Test
    ...
    def test_settlement_should_be_available
      settlement = Razorpay::Settlement.new(@client).fetch(@settlement_id)
    ...
    def test_fetch_all_settlement
      ...
      settlement = Razorpay::Settlement.new(@client).all
    ...
    def test_settlement_reports
      ...
      settlement = Razorpay::Settlement.new(@client).reports(para_attr)
    ...
    def test_settlement_should_be_created_on_demand
        ...
        settlement = Razorpay::Settlement.new(@client).create para_attr.to_json
    ...
    def test_fetch_all_instant_settlement
      ...
      settlement = Razorpay::Settlement.new(@client).fetch_all_ondemand_settlement
      assert_instance_of Razorpay::Collection, settlement, 'Settlement should be an array'
      refute_empty settlement.items, 'Settlement should be more than one'
    end
    ...
    def test_fetch_ondemand_settle_by_id
      ...
      settlement = Razorpay::Settlement.new(@client).fetch_ondemand_settlement_by_id(@settlement_id)
