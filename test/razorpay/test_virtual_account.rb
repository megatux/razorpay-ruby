...
module Razorpay
  ...
  class RazorpayVirtualAccountTest < Minitest::Test
    ...
    def test_virtual_account_should_be_created
      ...
      virtual_account = Razorpay::VirtualAccount.new(@client).create para_attr.to_json
    ...
    def test_close_virtual_account_class_method
      ...
      virtual_account = Razorpay::VirtualAccount.new(@client).close(@virtual_account_id)
    ...
    def test_fetch_all_virtual_accounts
      virtual_accounts = Razorpay::VirtualAccount.new(@client).all
      assert_instance_of Razorpay::Collection, virtual_accounts
    end

    def test_fetch_specific_virtual_account
      virtual_account = Razorpay::VirtualAccount.new(@client).fetch(@virtual_account_id)
      assert_instance_of Razorpay::VirtualAccount, virtual_account
    ...
    def test_fetch_payment_bank_transfer
      ...
      bank_transfer = Razorpay::Payment.new(@client).fetch(@payment_id).bank_transfer
    ...
    def test_fetch_virtual_account_payments
      ...
      payments = Razorpay::VirtualAccount.new(@client).fetch(@virtual_account_id).payments
    ...
    def test_virtual_account_add_receivers
      ...
      virtual_account = Razorpay::VirtualAccount.new(@client).add_receiver(@virtual_account_id,para_attr.to_json)
      assert_equal @virtual_account_id , virtual_account.id
    ...
    def test_virtual_account_allowed_payer
      ...
      virtual_account = Razorpay::VirtualAccount.new(@client).allowed_payer(@virtual_account_id,para_attr.to_json)
      assert_equal @virtual_account_id , virtual_account.id
    ...
    def test_virtual_account_delete_payer
      ...
      virtual_account = Razorpay::VirtualAccount.new(@client).delete_allowed_payer(@virtual_account_id,@payer_id)
